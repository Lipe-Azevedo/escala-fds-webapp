...
const CalendarSummary = ({ workedDays, holidaysWorked }: { workedDays: number; holidaysWorked: number; }) => {
  return (
    <div style={{display: 'flex', gap: '20px', justifyContent: 'center', padding: '15px', background: 'rgb(var(--card-background-rgb))', border: '1px solid rgb(var(--card-border-rgb))', borderRadius: '8px'}}>
...
export default function DashboardHomePage() {
  ...
  if (!user || user.userType === 'master' || isLoadingCalendar) {
